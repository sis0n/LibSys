...
async function loadCart() {
    try {
        const res = await fetch(`${BASE_URL}/faculty/cart/json`);
...
async function checkoutCart() {
    ...
    try {
        const res = await fetch(`${BASE_URL}/faculty/cart/checkout`, {
            method: "POST",
...
async function clearCart() {
    try {
        const res = await fetch(`${BASE_URL}/faculty/cart/clear`, {
            method: "POST"
        });
...
async function removeFromCart(cartId) {
    try {
        const res = await fetch(`${BASE_URL}/faculty/cart/remove/${cartId}`, {
            method: "POST"
        });
