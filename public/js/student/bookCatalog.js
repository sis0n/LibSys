window.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadBooks(page = 1) {
        ...
        // 🔵 Loading Animation - Add before API call
        Swal.fire({
            background: "transparent",
            html: `
                <div class="flex flex-col items-center justify-center gap-2">
            ...
            showConfirmButton: false,
            customClass: {
                popup: "!rounded-xl !shadow-md !border-2 !border-orange-400 !p-6 !bg-gradient-to-b !from-[#fffdfb] !to-[#eef6ff] shadow-[0_0_8px_#3b82f670]",
            },
        });
