...
async function loadCart() {
  try {
    const res = await fetch("/libsys/public/staff/cart/json");
...
async function checkoutCart() {
  ...
  try {
    const res = await fetch("/libsys/public/staff/cart/checkout", {
      method: "POST",
...
async function clearCart() {
  try {
    const res = await fetch("/libsys/public/staff/cart/clear", {
      method: "POST"
    });
...
async function removeFromCart(cartId) {
  try {
    const res = await fetch(`/libsys/public/staff/cart/remove/${cartId}`, {
      method: "POST"
    });
