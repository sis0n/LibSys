document.addEventListener('DOMContentLoaded', function () {
    ...
    async function fetchTableData() {
        try {
            const response = await fetch('/libsys/public/admin/returning/getTableData');
    ...
    async function handleBookCheck(accessionNumber) {
        ...
        try {
            ...
            const response = await fetch('/libsys/public/admin/returning/checkBook', {
                method: 'POST',
                body: formData
            });
    ...
    if (modalReturnButton) {
        modalReturnButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch('/libsys/public/admin/returning/markReturned', {
                    method: 'POST',
                    body: formData
                });
