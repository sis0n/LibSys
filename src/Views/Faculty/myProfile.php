      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-6 ml-9">
        ...
        <div class="flex items-center gap-3">
          <div>
            ...
            <input type="text" id="department" name="department" class="font-medium text-gray-800 bg-gray-50 border-gray-200 border rounded-md px-2 py-1 w-full" disabled>
          </div>
        </div>
        <div class="flex items-center gap-3">
          <div>
...
<script src="/libsys/public/js/faculty/myProfile.js" defer></script>