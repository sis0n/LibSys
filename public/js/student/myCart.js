...
async function loadCart() {
    try {
        const res = await fetch(`${BASE_URL}/student/cart/json`);
...
async function checkoutCart() {
    ...
    try {
        const res = await fetch(`${BASE_URL}/student/cart/checkout`, {
            method: "POST",
...
async function clearCart() {
    try {
        const res = await fetch(`${BASE_URL}/student/cart/clear`, {
            method: "POST"
        });
...
async function removeFromCart(cartId) {
    try {
        const res = await fetch(`${BASE_URL}/student/cart/remove/${cartId}`, {
            method: "POST"
        });
