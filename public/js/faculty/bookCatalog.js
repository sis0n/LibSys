window.addEventListener("DOMContentLoaded", () => {
    ...
    if (statusBtn && statusMenu && statusValue) {
        ...
        // Gumamit ng loadBooks (walang popup)
    ...
    async function addToCart(id) {
        ...
        try {
            ...
            if (typeof Swal != "undefined") {
                ...
                // 💡 Automatically close modal after adding to cart
    ...
    async function removeFromCart(id) {
        ...
        // 🟠 Loading Animation (Orange themed loading)
        Swal.fire({
            background: "transparent",
            html: `
            ...
            showConfirmButton: false,
            customClass: {
                // Orange border and shadow for cart loading
        ...
        try {
            ...
            if (typeof Swal != 'undefined') {
                ...
                Swal.fire({
                    ...
                    `,
                    customClass: {
                        // Correct Green border and shadow
    ...
    async function loadBooksInitial(page = 1) {
        ...
        try {
            ...
            // Binago ang timer delay mula 3000ms (3s) pabalik sa 1000ms (1s) para mas mabilis, pero sinunod ang delay logic
            ...
            // 🔴 Error Toast for LoadBooks failure
            Swal.fire({
                toast: true,
                position: "bottom-end",
                showConfirmButton: false,
    ...
    async function loadBooks(page = 1) {
        ...
        // --- INALIS ANG SWAL.FIRE DITO ---
        // --- INALIS ANG SWAL.CLOSE() DITO ---
        ...
        try {
            ...
            // Note: Walang timer at Swal.close() dito.
            ...
            // 🔴 Error Toast for LoadBooks failure (Hindi inalis)
            if (typeof Swal != 'undefined') {
                 Swal.fire({
                    toast: true,
                    position: "bottom-end",
