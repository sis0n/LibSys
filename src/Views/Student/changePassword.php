        ...
        <div class="w-full bg-white shadow-md rounded-xl p-6 mt-4">
            ...
            <form id="passwordForm" action="<?= BASE_URL ?>/api/change-password" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="current_password" id="current_password"
                            placeholder="Enter current password" required class="w-full bg-orange-50 border border-orange-300 rounded-md px-3 py-2 text-sm 
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="new_password" id="new_password" placeholder="Enter new password"
                            required class="w-full bg-orange-50 border border-orange-300 rounded-md px-3 py-2 text-sm 
                     placeholder:text-orange-500 placeholder:text-sm 
                     focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none 
                     hover:border-orange-400 transition-colors duration-200 pr-10">
                        <button type="button" onclick="togglePassword('new_password', this)" class="absolute right-3 top-2.5 text-gray-500 hover:text-orange-500 
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="confirm_password" id="confirm_password"
                            placeholder="Confirm new password" required class="w-full bg-orange-50 border border-orange-300 rounded-md px-3 py-2 text-sm 
                     placeholder:text-orange-500 placeholder:text-sm 
                     focus:ring-2 focus:ring-orange-400 focus:border-orange-400 outline-none 
                     hover:border-orange-400 transition-colors duration-200 pr-10">
                        <button type="button" onclick="togglePassword('confirm_password', this)" class="absolute right-3 top-2.5 text-gray-500 hover:text-orange-500 
                     transition-colors duration-300 ease-in-out">
                            <i class="ph ph-eye text-sm"></i>
                        </button>
                    </div>
                ...
                <div class="bg-orange-50 border border-orange-200 rounded-lg p-4 mt-6">
                    <h2
                        class="text-xl font-semibold flex items-center gap-2 mb-5 text-amber-600 text-center md:text-left">
                        Password Security
                    </h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            <h3
                                class="text-base font-semibold mb-2 flex items-center gap-2 text-orange-700 text-center sm:text-left">
                                Security Tips
                            </h3>
                            <ul class="list-disc list-inside text-amber-600 space-y-1 text-xs text-left">
