...
<body class="min-h-screen p-6">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div
            ...
            <p class="text-3xl font-bold mt-2"><?= $totalBorrowed ?></p> <span class="text-sm text-gray-500">Currently
                borrowed</span>
        </div>
        ...
        <div
            ...
            <p class="text-3xl font-bold mt-2 text-[var(--color-destructive)]"><?= $totalOverdue ?></p> <span
                class="text-sm text-gray-500">Need attention</span>
        </div>
    </section>
