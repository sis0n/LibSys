...
<section class="border border-orange-100 border-t-4 border-t-green-500 rounded-2xl shadow p-8 bg-white">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-items-center gap-4">
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    new Chart(document.getElementById("topVisitorsChart").getContext("2d"), {
      ...
      data: {
        labels: topLabels,
        datasets: [{ label: "Visits", data: topData, backgroundColor: "#22c55e", borderRadius: 6 }]
      },
    ...
    new Chart(document.getElementById("weeklyActivityChart").getContext("2d"), {
      ...
      data: {
        labels: weeklyLabels,
        datasets: [
          { label: "Visitors", data: visitorsData, borderColor: "#3b82f6", backgroundColor: "rgba(59,130,246,0.1)", tension: 0.4, fill: true },
          { label: "Borrows", data: borrowsData, borderColor: "#f59e0b", backgroundColor: "rgba(245,158,11,0.1)", tension: 0.4, fill: true }
        ]
      },
