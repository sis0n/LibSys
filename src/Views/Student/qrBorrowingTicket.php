    ...
    <div class="container mx-auto px-4 py-6 flex flex-col md:flex-row gap-6 justify-center items-stretch">
        ...
        <div
            ...
            <div class="mt-4 text-[var(--font-size-sm)] text-[var(--color-gray-700)]">
                <p class="font-medium">
                    Ticket Code:
                    <span class="text-[var(--color-primary)]"><?= $transaction_code ?></span>
                </p>
        ...
        <div
            ...
            <dl class="space-y-3 text-sm flex-1">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <dd class="text-right"><?= count($books) ?> Book(s)</dd>
                </div>
            </dl>
        </div>
    </div>
                ...
                <div class="bg-white p-4 flex gap-3 border-t border-green-100">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-2 mt-2 text-xs">
                            <span class="px-2 py-1 bg-gray-100 rounded">AccNo: <?= htmlspecialchars($book["accession_number"] ?? "N/A") ?></span>
                            <span class="px-2 py-1 bg-blue-100 text-blue-700 rounded"><?= htmlspecialchars($book["call_number"] ?? "N/A") ?></span>
                            <span class="px-2 py-1 bg-green-100 text-green-700 rounded"><?= htmlspecialchars($book["subject"] ?? "N/A") ?></span>
                        </div>
                    </div>
