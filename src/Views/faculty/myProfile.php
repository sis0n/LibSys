            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-6 ml-9">
                <div class="flex items-center gap-3">
                    <div>
                        ...
                        <input type="text" id="studentNumber" name="student_number" class="font-medium text-gray-800 bg-gray-100 border-gray-300 border rounded-md px-2 py-1 w-full" disabled>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                    <div>
                ...
                <div class="flex items-center gap-3">
                    <div>
                        ...
                        <input type="number" id="yearLevel" name="year_level" class="font-medium text-gray-800 bg-gray-50 border-gray-200 border rounded-md px-2 py-1 w-full" disabled>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                    <div>
                        <label class="text-sm text-gray-500" for="section">Section</label>
                        <input type="text" id="section" name="section" class="font-medium text-gray-800 bg-gray-50 border-gray-200 border rounded-md px-2 py-1 w-full" disabled>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                    <div>
...
<script src="/libsys/public/js/student/myProfile.js" defer></script>