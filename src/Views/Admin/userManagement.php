             ...
             <div class="space-y-4 mb-6">
                 ...
                 <div class="relative w-full">
                     ...
                     <div id="userRoleDropdownMenu"
                         class="absolute mt-1 w-full bg-white border border-orange-200 rounded-lg shadow-md hidden z-20">
                         <div class="user-role-item px-3 py-2 hover:bg-orange-100 cursor-pointer"
                 ...
                 <div class="grid grid-cols-2 gap-3 max-h-[70vh] overflow-y-auto rounded-xl p-2">
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         ...
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1">View archives</label>
                             <label class="block"><input type="checkbox" class="mr-1">Add archives</label>
                             <label class="block"><input type="checkbox" class="mr-1">Edit archives</label>
                             <label class="block"><input type="checkbox" class="mr-1">Delete archives</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         ...
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1">View items</label>
                             <label class="block"><input type="checkbox" class="mr-1">Add items</label>
                             <label class="block"><input type="checkbox" class="mr-1">Edit items</label>
                             <label class="block"><input type="checkbox" class="mr-1">Delete items</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         <h4 class="font-medium mb-2 text-orange-700 text-sm border-b border-orange-200 pb-1">Borrowing
                             System</h4>
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1">Borrow item</label>
                             <label class="block"><input type="checkbox" class="mr-1">Return item</label>
                             <label class="block"><input type="checkbox" class="mr-1">View borrowed history</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         ...
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1">Generate report</label>
                             <label class="block"><input type="checkbox" class="mr-1">Export report</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         <h4 class="font-medium mb-2 text-orange-700 text-sm border-b border-orange-200 pb-1">User
                             Management</h4>
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1">View users</label>
                             <label class="block"><input type="checkbox" class="mr-1">Add users</label>
                             <label class="block"><input type="checkbox" class="mr-1">Edit users</label>
                             <label class="block"><input type="checkbox" class="mr-1">Delete users</label>
                             <label class="block"><input type="checkbox" class="mr-1">Manage roles</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         <h4 class="font-medium mb-2 text-orange-700 text-sm border-b border-orange-200 pb-1">System
                             Settings</h4>
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1">View settings</label>
                             <label class="block"><input type="checkbox" class="mr-1">Modify settings</label>
                             <label class="block"><input type="checkbox" class="mr-1">Manage backup</label>
                             <label class="block"><input type="checkbox" class="mr-1">Restore data</label>
                         </div>
                     </div>
                 </div>
             </div>
                     ...
                     <div>
                         ...
                         <div class="relative w-full">
                             ...
                             <div id="editRoleDropdownMenu"
                                 class="absolute mt-1 w-full bg-white border border-orange-200 rounded-lg shadow-md hidden z-20">
                                 <div class="edit-role-item px-3 py-2 hover:bg-orange-100 cursor-pointer"
                     ...
                     <div>
                         ...
                         <div class="relative w-full">
                             ...
                             <div id="editStatusDropdownMenu"
                                 class="absolute mt-1 w-full bg-white border border-orange-200 rounded-lg shadow-md hidden z-20">
                                 <div class="edit-status-item px-3 py-2 hover:bg-orange-100 cursor-pointer"
