...
<body class="bg-white text-gray-800 h-screen flex flex-col relative overflow-hidden font-sans">
    <main class="flex-grow flex flex-col items-center justify-center px-4 text-center">
        <h1 class="text-9xl font-bold text-orange-500 tracking-tighter">400</h1>
        <h2 class="mt-4 text-2xl md:text-3xl font-semibold text-gray-900">Bad Request</h2>
        <p class="mt-3 text-gray-500 max-w-md mx-auto">The server couldn't understand your request due to invalid syntax. Please check your input.</p>
