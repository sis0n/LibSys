<div class="min-h-screen">
    <div class="mb-6">
        <h2 class="text-2xl font-bold mb-4 text-gray-800">Equipment Catalog</h2>
        <p class="text-gray-700">Browse and borrow computers and board games from our library.</p>
    </div>
    <div class="bg-[var(--color-card)] shadow-md border border-[var(--color-border)] rounded-xl p-6 mb-6">
        ...
        <p class="text-gray-600 mb-4">Find the equipment you need.</p>

        <div class="flex flex-col sm:flex-row gap-3">
            <div class="relative flex-1">
                <i class="ph ph-magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                <input id="searchInput" type="text" placeholder="Search by name, type..."
            ...
            <div class="relative">
                <button id="statusDropdownBtn"
                    ...
                    <span class="flex items-center gap-2 text-gray-700">
                        ...
                        <span id="statusDropdownValue">Available</span>
                    </span>
    ...
    <div id="equipmentGrid" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4"></div>

    <p id="noEquipmentFound" class="text-gray-500 text-center w-full hidden py-10">
        <i class="ph ph-game-controller text-4xl block mb-2 text-gray-400"></i>
        ...
        <div id="equipmentModalContent"
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="text-sm bg-white rounded-lg border border-gray-200 p-3 space-y-1">
                    ...
                    <p><span class="text-amber-700">Name:</span> <span id="infoName"></span></p>
                    <p><span class="text-amber-700">Type:</span> <span id="infoType"></span></p>
                    <p><span class="text-amber-700">Serial:</span> <span id="infoSerial" class="font-mono text-sm font-semibold text-orange-600"></span></p>
                    <p><span class="text-amber-700">Category:</span> <span id="infoCategory"></span></p>
                </div>

                <div class="bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg p-3 border border-orange-200">
                    <p class="font-semibold text-orange-900 mb-1 text-sm">Note</p>
                    <p class="text-amber-700 text-sm" id="modalNote"></p>
                </div>
            </div>

            <div class="px-3 py-4 bg-gray-50 border-t border-[var(--color-border)]">
