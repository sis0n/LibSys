                ...
                <div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Dela" name="middle_name" class="w-full px-4 py-2 rounded-lg border border-amber-300 bg-white focus:ring-2 focus:ring-amber-500 outline-none transition text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="suffix" placeholder="(Jr., Sr.)" class="w-full px-4 py-2 rounded-lg border border-amber-300 bg-white focus:ring-2 focus:ring-amber-500 outline-none transition text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="roleDropdownBtn" class="w-full flex items-center justify-between px-4 py-2 rounded-lg border border-amber-300 bg-white text-left focus:ring-2 focus:ring-amber-500 outline-none transition text-sm">
                                <span id="roleDropdownValue">Select Role</span>
                                <i class="ph ph-caret-down text-gray-500"></i>
                            </button>
                            <div id="roleDropdownMenu" class="absolute mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg hidden z-20">
                                <ul class="py-1">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="collateral_id" name="collateral_id" placeholder="Library ID, School ID, Valid ID ..." autocomplete="off" class="w-full px-4 py-2 rounded-lg border border-amber-300 bg-white focus:ring-2 focus:ring-amber-500 outline-none transition text-sm pr-10">
                            <button type="button" id="collateral_id_dropdown_arrow" class="absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                                <i class="ph ph-caret-down"></i>
                            </button>
                            <div id="collateral_id_suggestions" class="absolute mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg hidden z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="itemTypeDropdownBtn" class="w-full flex items-center justify-between px-4 py-2 rounded-lg border border-emerald-300 bg-white text-left focus:ring-2 focus:ring-emerald-500 outline-none transition text-sm">
                            <span id="itemTypeDropdownValue">Equipment</span>
                            <i class="ph ph-caret-down text-gray-500"></i>
                        </button>
                        <div id="itemTypeDropdownMenu" class="absolute mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg hidden z-10">
                            <ul class="py-1">
