...
document.addEventListener('DOMContentLoaded', () => {
    ...
    profileForm?.addEventListener('submit', async (e) => {
        ...
        if (!hasProfilePic && !croppedBlob && !originalProfileData.profile_picture) {
        ...
        try {
            const res = await fetch('api/staff/myprofile/update', { method: 'POST', body: formData }); // Staff Endpoint
