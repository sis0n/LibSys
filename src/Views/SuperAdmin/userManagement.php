 ...
 <div class="bg-[var(--color-card)] border border-orange-200 rounded-xl shadow-sm p-6 mt-6">
     <div class="flex items-center justify-between mb-4">
         <div>
             <h3 class="text-lg font-semibold text-gray-800">User Database</h3>
             <p class="text-sm text-gray-600">All registered users in the system</p>
         </div>
         <!-- Filters -->
     ...
     <div
         ...
         <div class="p-6 max-h-[90vh] overflow-y-auto">
                 ...
                 <div class="grid grid-cols-2 gap-3 max-h-[70vh] overflow-y-auto rounded-xl p-2">
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         ...
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">View archives</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Add archives</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Edit archives</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Delete archives</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         ...
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">View items</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Add items</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Edit items</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Delete items</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         <h4 class="font-medium mb-2 text-orange-700 text-sm border-b border-orange-200 pb-1">Borrowing
                             System</h4>
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Borrow item</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Return item</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">View borrowed history</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         ...
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Generate report</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Export report</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         <h4 class="font-medium mb-2 text-orange-700 text-sm border-b border-orange-200 pb-1">User
                             Management</h4>
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">View users</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Add users</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Edit users</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Delete users</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Manage roles</label>
                         </div>
                     </div>
                     ...
                     <div class="border rounded-md p-3 bg-orange-50/50 border-orange-200">
                         <h4 class="font-medium mb-2 text-orange-700 text-sm border-b border-orange-200 pb-1">System
                             Settings</h4>
                         <div class="space-y-1 text-sm text-gray-700">
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">View settings</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Modify settings</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Manage backup</label>
                             <label class="block"><input type="checkbox" class="mr-1 accent-orange-500">Restore data</label>
                         </div>
                     </div>
                 </div>
             </div>
             ...
             <div class="flex justify-end gap-2 mt-6">
                 ...
                 <button class="bg-[var(--color-ring)] text-white px-4 py-2 rounded-md hover:opacity-90 transition">
                     Add User
                 </button>
             </div>
         </div>
         ...
         <div class="p-6 max-h-[90vh] overflow-y-auto">
             ...
             <div class="flex justify-end gap-3 mt-6">
                 <button id="cancelEditUser"
                     class="border border-gray-300 px-4 py-2 rounded-md text-gray-700 hover:bg-gray-100 transition">
                     Cancel
                 </button>
     ...
     function renderTable() {
        ...
        <td class="px-4 py-3">
            <div class="flex items-center gap-2">
                <button class="editUserBtn p-1 text-xl text-gray-600 hover:text-green-400">
                    <i class="ph ph-note-pencil"></i>
                </button>
                <button class="p-1 text-xl text-gray-600 hover:text-red-400"
