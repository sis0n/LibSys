document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchDeletedBooks() {
        showLoadingState();
        try {
            const response = await fetch(`${BASE_URL}/superadmin/restoreBooks/fetch`);
    ...
    async function handleRestore(bookId, title, buttonEl) {
        ...
        try {
            const response = await fetch(`${BASE_URL}superadmin/restoreBooks/restore`, {
                method: 'POST',
                headers: {
    ...
    async function handleArchive(bookId, title, buttonEl) {
        ...
        try {
            const response = await fetch(`${BASE_URL}superadmin/restoreBooks/archive/${bookId}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken
